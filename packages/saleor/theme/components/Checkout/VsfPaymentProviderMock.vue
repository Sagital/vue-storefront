...
import { usePaymentMethods } from '@vue-storefront/saleor';
...
export default {
  ...
  setup (props, context) {
    ...
    const {paymentMethods, loadPaymentMethods, createPayment } = usePaymentMethods();
    ...
    const selectPaymentMethod = async (paymentMethod) => {
      ...
      // TODO, this can create multiple payments if selected multiple times. Ideally we would want a cash on delivery
      //  addon which lets you place an order without a payment
