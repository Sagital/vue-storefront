...
import { useCart, useBilling, useShipping, cartGetters } from '@vue-storefront/saleor';
import { onSSR } from '@vue-storefront/core';
import { useMakeOrder } from '@vue-storefront/saleor';
...
export default {
  ...
  setup(props, context) {
    ...
    const { shipping: shippingDetails, load: loadShippingDetails, loading } = useShipping();
